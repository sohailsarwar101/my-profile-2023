...
var notepade = document.getElementById('content');
notepade.addEventListener("input", uploadContent);
...
function uploadContent() {
    ...
    if (content !== textarea.value) {
        ...
        processing.innerText = "Auto saving...";
        ...
        request.onload = function() {
            if (request.readyState === 4) {
                ...
                setTimeout(function(){ processing.innerHTML = "Auto Saved &#x2713;" }, 1000);
            }
        }
